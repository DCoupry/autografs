...
class SBU(object):
    ...
    def __str__(self):
        ...
        for atom in self.atoms:
            ...
            s = ("{sy:<3} {p0:>5.2f} {p1:>5.2f} {p2:>5.2f}"
                 "{tp:<5}\n").format(sy=sy,
                                     p0=p0,
                                     p1=p1,
                                     p2=p2,
    ...
    def set_atoms(self,
        ...
        ----------
        atoms: ase.Atoms
            the atoms object to use as the SBU
            template
        analyze: bool
            if True, reanalyzes the properties
            of the SBU
    ...
    def copy(self):
        ...
        Returns
        -------
        new: autografs.utils.sbu.SBU
            a new deep copy of the current SBU
        """
    ...
    def is_compatible(self,
        ...
        ----------
        shape: tuple
            the shape of a slot with which to compare the
            compatibility of the SBU
        point_group: str
            the point group of the slot
        coearcion: bool
        ...
        -------
        compatible: bool
            is the sbu compatible with the given slot
        """
        compatible = False
    ...
    def get_atoms(self):
        ...
        -------
        atoms: set
            the copy of the current topology atoms attribute
...
def read_sbu_database(update=False,
    ...
    """Return a dictionnary of ASE Atoms as SBUs
        ...
        ----------
        update: bool
            if True, reread and update all SBU found in
            the given libraries
        path: str or Path
            path to the SBU files to read
        use_defaults: bool
            if True, read the default libraries
        Returns
        -------
        sbu: {str: ase.Atoms, ...}
